...
import 'package:cinemagic22/blocs/theme_bloc.dart';
                    ...
                    children: [
                      ...
                      ListTile(
                        ...
                        leading: CircleAvatar(
                          ...
                          radius: 18,
                          child:  FaIcon(FontAwesomeIcons.globeAsia,
                            size: 18,
                            color: Colors.white,
                          ),
                        ),
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      ListTile(
                        ...
                        trailing: FaIcon(FontAwesomeIcons.chevronRight,),
                        onTap: () => AppService()
                            .openLink(context, Config.popcornkhUrl),
                      ),
                      ...
                      ListTile(
                        ...
                        trailing:  FaIcon(FontAwesomeIcons.chevronRight,),
                        onTap: () => AppService()
                            .openLink(context, Config.movieloverUrl),
                ),
      ...
      children: [
        ListTile(
          ...
          leading: CircleAvatar(
            backgroundColor: Colors.blueAccent,
            radius: 18,
            child: FaIcon(FontAwesomeIcons.userCheck,
              size: 18,
              color: Colors.white,
            ),
          ),

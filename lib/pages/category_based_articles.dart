...
class CategoryBasedArticles extends StatefulWidget {
  ...
  const CategoryBasedArticles(
      {Key? key, required this.categoryName, required this.categoryId, this.categoryThumbnail, this.heroTag})
      : super(key: key);
  ...
  FlexibleSpaceBar _flexibleSpaceBar(BuildContext context) {
    return FlexibleSpaceBar(
              ...
              background: Container(
                ...
                : Hero(
                  tag: widget.heroTag!, 
                  child: CustomCacheImageWithDarkFilterBottom(imageUrl: widget.categoryThumbnail, radius: 0.0)
                ),
              ),

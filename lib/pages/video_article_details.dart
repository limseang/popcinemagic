...
import 'package:cinemagic22/models/constants.dart';
import 'package:cinemagic22/services/app_service.dart';
import 'package:cinemagic22/utils/next_screen.dart';
import 'package:cinemagic22/widgets/bookmark_icon.dart';
import 'package:cinemagic22/widgets/full_image.dart';
import 'package:cinemagic22/widgets/local_video_player.dart';
import 'package:provider/provider.dart';
import 'package:cinemagic22/widgets/related_articles.dart';
            ...
            children: [
              Container(
                child: Html(
                  ...
                  tagsList: ['html', 'body', 'figure', 'video'],
                  style: {
                    "body": Style(
                              ...
                              children: <Widget>[
                                TextButton.icon(
                                  ...
                                  onPressed: () => nextScreenPopup(
                                      context, CommentsPage(id: article.id)),
                                )
                              ],
                            ),
                            Html(
